...
describe("Full I/O (2.0)", () => {
    ...
    let TESTS: TestSpec[] = [
        ...
        { name: "Definitions (Schema+Extension)",       test: "tests/fixtures/full-io/2.0/definitions/schema-with-extension.json" },
...
describe("Full I/O (3.0)", () => {
    ...
    let TESTS: TestSpec[] = [
        ...
        { name: "Components (Schemas + extensions)",    test: "tests/fixtures/full-io/3.0/components/components-schemas-extensions.json" },
